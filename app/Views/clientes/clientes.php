            ...
            <main class="col-md-9 col-lg-10 p-4 conteudo">
                <div class="row mb-4">
                    ...
                    <table id="example" class="table text-light" >
                        ...
                        <tbody>
                            <tr><td>1</td><td>Ana Silva</td><td>ana@email.com</td><td>Ativo</td></tr>
                            <tr><td>2</td><td>João Souza</td><td>joao@email.com</td><td>Inativo</td></tr>
                            <tr><td>3</td><td>Maria Costa</td><td>maria@email.com</td><td>Ativo</td></tr>
                        </tbody>
                </table>
            </main>
        </div>
