...
<body>
            ...
            <div class="col-4 p-4" style="background-color:#fff; border-radius: 30px; box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.5);">
                ...
                <div class="row justify-content-center">
                    <div class="col-10 mt-3">
                        <?= form_open('/nova_senha', ['id' => 'formSalvarNovaSenha']) ?>
                            <?= csrf_field() ?>
                        ...
                        <?= form_close() ?>   
                        <button id="salvarNovaSenha" class="form-control btn btn-danger mt-3">Salvar Senha</button> 
                    </div>
                </div>
            </div>
        </div>
    ...
    <script src="<?= base_url('js/nova_senha.js') ?>"></script> <!-- Js Nova Senha -->
</body>
</html>