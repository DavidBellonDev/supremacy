...
<header>
    ...
    <div class="menu">
        <ul>
            ...
            <li class="menu-item hidden"><a href="https://codeigniter.com/user_guide/" target="_blank">Documentos</a>
            </li>
            <li class="menu-item hidden"><a href="https://forum.codeigniter.com/" target="_blank">Comunidade</a></li>
            <li class="menu-item hidden"><a
                    href="https://codeigniter.com/contribute" target="_blank">Contribua</a>
            </li>
        </ul>
    </div>
    <div class="heroe">
        <h1>Bem-Vindo ao CodeIgniter <?= CodeIgniter\CodeIgniter::CI_VERSION ?></h1>
        <h2>Esse pequeno Framework tem grandes poderes</h2>
    </div>
...
<section>
    ...
    <p>Essa página que você está vendo foi gerada dinamicamente pelo CodeIgniter.</p>
    <p>Se você desejar editar ela, poderá encontra-la em:</p>
    <pre><code>app/Views/welcome_message.php</code></pre>
    <p>O Controller correspondente poderá ser encontrado em:</p>
